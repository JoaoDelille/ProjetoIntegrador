function [SPL_max] = noise_estimation(m,NB,NR,r,s,t_c_max,Vtip,Phr,Thr,alt,rho,a)
  ...
  % Inputs:
   ...
   Vtip=0.5*339.709 %- velocity at the tip of the rotor (m/s)
   Phr=1.2773e+05 %- hover power per rotor (W) 115 000 9.8104e+04
   Thr=4.9033e+03 %- thrust generated per rotor in hover (N) 4905 3677.5 4883.248296 

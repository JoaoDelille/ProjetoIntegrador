...
mass_ratio = 2*Mtom/S/rho/chord/cl_alfa
...
deltan1 = 1 + 0.5*rho*Ua*V*cl_alfa*S/Mtom/9.81;
deltan11 = 1 - 0.5*rho*Ua*V*cl_alfa*S/Mtom/9.81;
deltan111 = 0.5*rho*Ua*V_A*cl_alfa*S/Mtom/9.81
VV = 0:0.1:V_C;
deltan2 = 1 + 0.5*rho*Uc*VV*cl_alfa*S/Mtom/9.81;
deltan22 = 1 - 0.5*rho*Uc*VV*cl_alfa*S/Mtom/9.81;
deltan222 = 0.5*rho*Uc*V_C*cl_alfa*S/Mtom/9.81
VVV = 0:0.1:V_D;
deltan3 = 1 + 0.5*rho*Ud*VVV*cl_alfa*S/Mtom/9.81;
deltan33 = 1 - 0.5*rho*Ud*VVV*cl_alfa*S/Mtom/9.81;
deltan333 = 0.5*rho*Ud*V_D*cl_alfa*S/Mtom/9.81
